...
namespace Stdf.Attributes
{
	...
	public class FieldLayoutAttribute : Attribute
	{
        ...
        /// <remarks>
        ///     <para>
        ///         The default value is false.  Setting this to true requires that a
        ///         <see cref="MissingValue" /> be defined, but the presence of a <see cref="MissingValue" /> does not
        ///         require this to be set to true.
        ///     </para>
        ///     <para>
        ///         The STDF specification defines the concept of optional field and missing or invalid
        ///         data.  Optional fields are those that are not required for a minimally valid STDF file.  The
        ///         Stdf implementation diverges slightly from this concept in that missing or invalid fields
        ///         are represented as null when the record is in object form.  That divergence leads to a separation
        ///         of the concepts of optional and simply having a missing/invalid placeholder value.
        ///     </para>
        ///     <para>
        ///         Non-optional fields must be present in the STDF file.  When a non-optional field is unable to
        ...
        ///         write is attempted, either the <see cref="MissingValue" /> will be used, or the writing of the record will
        ///         fail.
        ///     </para>
        ///     <para>
        ///         Optional fields may be present in the STDF file, but are not required when found at the end
        ///         of the record.  When an optional field is unable to be read, null is assigned to the corresponding
        ///         property.  When an optional field’s property is null and a write is attempted, either the
        ///         <see cref="MissingValue" />
        ///         will be used, or the field will not be written if at the end of the record.
        ///     </para>
        /// </remarks>
        ...
        ///     <para>
        ///         The STDF specification clearly defines the concept of a value to use to
        ...
        ///         will be left off of the end of the record if possible.
        ///     </para>
        /// </remarks>
