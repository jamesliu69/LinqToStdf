...
namespace Stdf
{
    ...
    ///             <item>
    ///                 They should not "leak" records parsed from the file itself.
    ...
    ///                 This does not apply to error records or other injected/synthesized records.
    ///             </item>
    ///         </list>
    ///     </para>
    /// </remarks>
    public static class CompiledQuery
	{
        ...
        public static Func<string, TResult> Compile<TResult>(Expression<Func<StdfFile, TResult>> query) => Compile(null, query);
		...
		{
			RecordsAndFields        rnf      = ExpressionInspector.Inspect(query);
			Func<StdfFile, TResult> compiled = query.Compile();
		...
		public static Func<string, T1, TResult> Compile<T1, TResult>(Expression<Func<StdfFile, T1, TResult>> query) => Compile(null, query);
		...
		{
			RecordsAndFields            rnf      = ExpressionInspector.Inspect(query);
			Func<StdfFile, T1, TResult> compiled = query.Compile();
			RecordConverterFactory      factory  = null;
		...
		public static Func<string, T1, T2, TResult> Compile<T1, T2, TResult>(Expression<Func<StdfFile, T1, T2, TResult>> query) => Compile(null, query);
		...
		{
			RecordsAndFields                rnf      = ExpressionInspector.Inspect(query);
			Func<StdfFile, T1, T2, TResult> compiled = query.Compile();
			RecordConverterFactory          factory  = null;
		...
		public static Func<string, T1, T2, T3, TResult> Compile<T1, T2, T3, TResult>(Expression<Func<StdfFile, T1, T2, T3, TResult>> query) => Compile(null, query);
		...
		{
			RecordsAndFields                    rnf      = ExpressionInspector.Inspect(query);
			Func<StdfFile, T1, T2, T3, TResult> compiled = query.Compile();
			RecordConverterFactory              factory  = null;
